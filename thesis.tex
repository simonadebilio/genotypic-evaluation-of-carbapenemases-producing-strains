...
%Il totale dei casi analizatti ha mostrato resistenze.
%In italia il problema delle resistenze, dla dato del 2015, è risultato essere x. questo ci pone tra i paaesi con ... (cit)
...
%mettere a posto:
%correggere spelling usa vs uk
%titolo ultimi capitoli 
%citazioni immagini
%controllare com'è scritto GeneXpert
%mettere in corsivo i nomi commerciali
%trovare stemma universita'

%Luca sistema immagini 2.1 e 2.2 e 2.3
%Luca fara' la pagina del titolo
