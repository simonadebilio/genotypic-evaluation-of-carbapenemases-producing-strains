...
VITEK® 2 is a fully automated system that performs bacterial identification, and antibiotic susceptibility testing. (biomerieux) %quote
...
%(? in italiano si chiamano "pozzetti" ma non sono riuscita a trovare un corrispettivo se non questo) 
...
%Simona lavora 6 mesi: vede X campioni di cose e li semina = X piastre
%Simona analizza X piastre e trova che Y ha la Klebsiella
%Simona fa antibiogramma su Y piastre
%Il medico analizza le Y piastre e ne sceglie 38
